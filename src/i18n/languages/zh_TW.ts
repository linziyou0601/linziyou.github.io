...
export const zh_TW: Translation = {
	...
	[Key.friends]: "友情連結",
	[Key.friendsDescription]: "這裡是我的朋友們，歡迎互相拜訪交流",
	[Key.guestbook]: "留言",
	...
	[Key.rssBenefit1]: "及時取得網站最新內容，無需手動存取",
	...
	// 加密
	[Key.postEncrypted]: "文章已加密",

	// 背景圖模式
	[Key.wallpaperMode]: "背景圖模式",
	[Key.wallpaperBannerMode]: "橫幅背景圖",
	...
	[Key.sponsorDescription]:
		"如果我的內容對你有幫助，歡迎透過以下方式贊助我，你的支持是我持續創作的動力！",
	...
	[Key.scanToSponsor]: "掃描 QR Code 贊助",
	...
	[Key.passwordProtectedRss]: "文章已加密保護，請存取網站查看。",
};
